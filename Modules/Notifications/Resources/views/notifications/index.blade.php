                    ...
                    @if (isExist($notification->data['target_type'], $notification->data['target_id']))
                        <tr>
                            <td class="d-none d-md-table-cell">
                                <img src="{{ $notification->data['sender_image'] ?? "https://www.gravatar.com/avatar/454141dab8fba2c55bc2d81247a629a4?d=mm" }}" class="mr-2 rounded-circle" width="50px" height="50px">
                            </td>
                            <td>
