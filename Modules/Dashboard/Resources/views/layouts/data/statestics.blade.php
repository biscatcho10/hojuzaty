        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-8">
                        <div>
                            <p class="text-muted fw-medium mt-1 mb-2">{{ __('Vendors') }}</p>
                            <h4>{{ $vendors }}</h4>
                        </div>
                    </div>
                                                    ...
                                                    <g id="SvgjsG1457">
                                                        ...
                                                        <g id="SvgjsG1459" class="apexcharts-datalabels-group"
                                                            ...
                                                            <text id="SvgjsText1460"
                                                                ...
                                                                font-weight="400" fill="#373d3f"
                                                                class="apexcharts-text apexcharts-datalabel-value"
                                                                style="font-family: Helvetica, Arial, sans-serif;">{{ $vendors }}</text>
                                                        </g>
                                                    </g>
                                                </g>
                                            </g>
                ...
                </span>{{ __('Total Number of Vendors') }}</p>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-8">
                        <div>
                            <p class="text-muted fw-medium mt-1 mb-2">{{ __('Deliveries') }}</p>
                            <h4>{{ $deliveries }}</h4>
                        </div>
                    </div>
                                                    ...
                                                    <g id="SvgjsG1457">
                                                        ...
                                                        <g id="SvgjsG1459" class="apexcharts-datalabels-group"
                                                            ...
                                                            <text id="SvgjsText1460"
                                                                ...
                                                                font-weight="400" fill="#373d3f"
                                                                class="apexcharts-text apexcharts-datalabel-value"
                                                                style="font-family: Helvetica, Arial, sans-serif;">{{ $deliveries }}</text>
                                                        </g>
                                                    </g>
                                                </g>
                                            </g>
                ...
                </span>{{ __('Total Number of Deliveries') }}</p>
            </div>
        </div>
    </div>
</div>
